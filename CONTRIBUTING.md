...
https://metacpan.org/release/WebService-MinFraud

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends WebService::MinFraud
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends WebService::MinFraud
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/minfraud-api-perl).
...
can submit an issue report [via the web](https://github.com/maxmind/minfraud-api-perl/issues)
).
